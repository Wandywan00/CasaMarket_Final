...
namespace CasaMarket.API.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(CasaMarketApplicationContext context)
        {
            _context = context;
        }
        ...
        {
            var casaMarketApplicationContext = _context.Orders.Include(o => o.Buyer);
        ...
        public async Task<IActionResult> Create([Bind("OrderID,BuyerID,SellerID,State,OrderDate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderID,BuyerID,SellerID,State,OrderDate")] Order order)
        {
            if (id != order.OrderID)
            {
                return NotFound();
